<?php if ( ! function_exists( 'seobreadcrumbs' ) ) : function seobreadcrumbs() { $separator = '&rsaquo;'; $home = 'Home'; echo '<div class="location" xmlns:v="http://rdf.data-vocabulary.org/#">'; global $post; echo ' <span typeof="v:Breadcrumb"> <a class="iconIndex" rel="v:url" property="v:title" href="ÊýÔÆ¹«Ë¾ÍøÕ¾Ê×Ò³"></a> </span> '; $category = get_the_category(); if ($category) { foreach($category as $category) { echo $separator . "<span typeof=\"v:Breadcrumb\"> <a rel=\"v:url\" property=\"v:title\" href=\"".get_category_link($category->term_id)."\" >$category->name</a> </span>"; } } echo '</div>'; } endif; ?>
...
function twentyeleven_continue_reading_link() {
	return ' <a style="display:none;" class="but_details" href="'. esc_url( get_permalink() ) . '">' . __( 'ÏêÇé <span class="meta-nav"></span>', 'twentyeleven' ) . '</a>';
}
...
function login_protection(){
    if($_GET['shuyun_admin_22'] != 'crm_newBI')header('Location: http://www.shuyun.com/');
}
