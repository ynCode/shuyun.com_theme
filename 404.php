...
get_header(); ?>
	...
	<div id="primary" class="errorStyle">
                <ul class="errorUl">
                   <li class="tipFontA">糟糕，无法找到此页面！</li>
                   <li class="tipFontB">对不起！您所访问的页面不存在或者已删除。</li>
                   <li><a class="butGreen" href="http://www.shuyun.com/">返回首页</a><a class="butGreen" href="http://www.shuyun.com">刷新</a></li>
                </ul>
